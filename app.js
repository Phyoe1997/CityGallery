...
//Create an array with all imags

// const allImags = [img1,img2,img3,img4,img5,img6,img7,img8];
// allImags[0].addEventListener('click',switchImg);
// allImags[1].addEventListener('click',switchImg);
// allImags[2].addEventListener('click',switchImg);
// allImags[3].addEventListener('click',switchImg);
// allImags[4].addEventListener('click',switchImg);
// allImags[5].addEventListener('click',switchImg);
// allImags[6].addEventListener('click',switchImg);
// allImags[7].addEventListener('click',switchImg);
